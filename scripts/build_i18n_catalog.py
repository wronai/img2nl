...
for lang in LANGS:
    pack = PACKS.get(lang, PACKS["en"]).copy()
    for key in KEYS:
        pack.setdefault(key, PACKS["en"][key])
    PACKS[lang] = pack
